export const returnTests = [
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "7800", socialSecurityBenefitsTotal: "2600", socialSecurityBenefitsTaxable: "2500"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "1250", socialSecurityBenefitsTotal: "0", socialSecurityBenefitsTaxable: "0"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "1300", socialSecurityBenefitsTotal: "4000", socialSecurityBenefitsTaxable: "3700"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "6500", socialSecurityBenefitsTotal: "0", socialSecurityBenefitsTaxable: "0"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "0", socialSecurityBenefitsTotal: "4000", socialSecurityBenefitsTaxable: "0"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "6400", socialSecurityBenefitsTotal: "0", socialSecurityBenefitsTaxable: "0"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "0", socialSecurityBenefitsTotal: "4300", socialSecurityBenefitsTaxable: "3900"}
		],
	...
	},
	{
		...
		residenceHistory: [{}],
		dependents: [
			{AGI: "2500", socialSecurityBenefitsTotal: "0", socialSecurityBenefitsTaxable: "0"}
		],
