...
const MeetsRequirementsResults = ({ residenceHistoryStateKeys }) => (
  <p className="qualification-status qualification-success">
    ...
    in {maybePluralizedState(residenceHistoryStateKeys)} that did not expand
    medicaid, you meet this requirement.
  </p>
);

const DoesNotMeetRequirementsResults = props => (
  <p className="qualification-status">
    <span style={{ color: "red" }}>&#x2716;</span>&nbsp;&nbsp;Since you lived in
    a state that expanded medicaid, you do not meet this requirement.
  </p>
);
  ...
  return (
    <div className="qualification-section">
      <p className="requirement">
        ...
        {getStates(props.taxYear, props.residenceHistoryStateKeys)}.
      </p>
